...
public class MinimumWaitingTimeProblem {
     ...
     *
     */
    public MinimumWaitingTimeProblem() {
        problem = Problem.builder()
            .withTestCaseList(
                Arrays.asList(
                    TestCase.builder()
                        .withInputParameters(Arrays.asList(
                            new Input<>(Arrays.asList(3, 2, 1, 2, 6))
                        ))
                        .withOutput(new Output<>(17))
                        .build(),
                    TestCase.builder()
                        .withInputParameters(Arrays.asList(
                            new Input<>(Arrays.asList(1, 2, 4, 5, 2, 1))
                        ))
                        .withOutput(new Output<>(23))
                        .build()
                )
            )
            .build();
